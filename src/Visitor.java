import grammar.InejSetBaseVisitor;
...
public class Visitor extends InejSetBaseVisitor<String> {

    List<String> errors = new ArrayList<>();
    Variables variables = new Variables();
    Map<String, String> functions = new HashMap<>();
    Map<String, InejSetParser.SignatureFunctionContext> functionSignatures = new HashMap<>();

    @Override
    public String visitDeclaration(InejSetParser.DeclarationContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitProgram(InejSetParser.ProgramContext ctx) {
        String buffer = program;
        String buffer1 = "";
        for (InejSetParser.FunctionReturnContext context : ctx.functionReturn())
            buffer1 += visitFunctionReturn(context);
        for (InejSetParser.FunctionNonReturnContext context : ctx.functionNonReturn())
    ...
    @Override
    public String visitBlock(InejSetParser.BlockContext ctx) {
        variables.increase();
        String buffer = "{\n";
        for (InejSetParser.ContentContext context : ctx.content())
    ...
    @Override
    public String visitPrint(InejSetParser.PrintContext ctx) {
        return "\tSystem.out.println(" + ctx.LINE().getText() + ");";
    }

    @Override
    public String visitPrintSet(InejSetParser.PrintSetContext ctx) {
        if (variables.get(ctx.NAME().getText()) == null) {
    ...
    @Override
    public String visitExpression(InejSetParser.ExpressionContext ctx) {
    ...
    @Override
    public String visitContent(InejSetParser.ContentContext ctx) {
        if (ctx.print() != null)
    ...
    @Override
    public String visitInputSignature(InejSetParser.InputSignatureContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitType(InejSetParser.TypeContext ctx) {
        if (ctx.SET() != null)
            return "Set";
        if (ctx.ELEMENT() != null)
            return "Element";
    ...
    @Override
    public String visitSignatureFunction(InejSetParser.SignatureFunctionContext ctx) {
        String buffer = "(";
    ...
    @Override
    public String visitFunctionReturn(InejSetParser.FunctionReturnContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitFunctionNonReturn(InejSetParser.FunctionNonReturnContext ctx) {
        String buffer = "";
        if (functions.get(ctx.NAME().getText()) == null)
    ...
    @Override
    public String visitBlockReturn(InejSetParser.BlockReturnContext ctx) {
        String buffer = "{\n";
        for (InejSetParser.ContentContext context : ctx.content())
            buffer += visitContent(context) + "\n";
    ...
    @Override
    public String visitBlockNonReturn(InejSetParser.BlockNonReturnContext ctx) {
        String buffer = "{\n";
        for (InejSetParser.ContentContext context : ctx.content())
            buffer += visitContent(context) + "\n";
        buffer += "return;\n}\n";
    ...
    @Override
    public String visitFunctionCall(InejSetParser.FunctionCallContext ctx) {
        String buffer = "";
        if (functions.get(ctx.NAME().getText()) == null) {
    ...
    @Override
    public String visitSimpleCompare(InejSetParser.SimpleCompareContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitEqualCompare(InejSetParser.EqualCompareContext ctx) {
        String buffer = "";
        if (ctx.EQUAL() != null)
    ...
    @Override
    public String visitCompare(InejSetParser.CompareContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitSizeExpression(InejSetParser.SizeExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitNegationCompare(InejSetParser.NegationCompareContext ctx) {
        return "!(" + visitSimpleCompare(ctx.simpleCompare()) + ")";
    }

    @Override
    public String visitElseBlock(InejSetParser.ElseBlockContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitIfBlock(InejSetParser.IfBlockContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitWhileBlock(InejSetParser.WhileBlockContext ctx) {
        String buffer = "";
        if (ctx.simpleCompare() != null)
    ...
    @Override
    public String visitDeclarationElement(InejSetParser.DeclarationElementContext ctx) {
        String buffer = "";
        if (variables.get(ctx.NAME().getText()) != null) {
            if (ctx.ELEMENT() != null) {
                errors.add("Initialize error: Variable " + ctx.NAME().getText() + " already used");
    ...
    @Override
    public String visitIndexOfExpression(InejSetParser.IndexOfExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitGetExpression(InejSetParser.GetExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitSetExpression(InejSetParser.SetExpressionContext ctx) {
        for (int i = 0; i < ctx.NAME().size(); i++) {
    ...
    boolean checkSignatures(InejSetParser.InputSignatureContext in, InejSetParser.SignatureFunctionContext sig) {
        boolean check = true;
        if (sig == null && in == null)
           return true;
        if (sig == null || in == null)
